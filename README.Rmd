...
[![Codecov test coverage](https://codecov.io/gh/aliciasales/rc.pregnancy.a/branch/main/graph/badge.svg)](https://app.codecov.io/gh/aliciasales/rc.pregnancy.a?branch=main)
...
`rc.pregnancy.a` code is released under the [MIT license](https://opensource.org/license/mit/) and its data under the [CC BY 4.0 license](https://creativecommons.org/licenses/by/4.0/).
...
This project was supported with scholarships provided by the [University of Sao Paulo (USP)](http://usp.br/) (❤️).
